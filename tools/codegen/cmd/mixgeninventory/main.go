...
import (
	...
	"istio.io/core/tools/codegen/pkg/inventory"
)
...
func withArgs(args []string, errorf func(format string, a ...interface{})) {
	...
	rootCmd := cobra.Command{
		...
		Long: "Generates mixer adapter inventory source code from an input map of adapter packages to include in the inventory.\n" +
			"Example: mixgeninventory -p prometheus:istio.io/core/adapter/prometheus -p stdio:istio.io/core/adapter/stdio",
	...
	rootCmd.PersistentFlags().StringArrayVarP(&mappings, "packages", "p", []string{},
		"colon-separated mapping of Go packages to their full import paths. Example: -p prometheus:istio.io/core/adapter/prometheus")
